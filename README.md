...
**Key Features:**
- 26 statistical datasets covering employment, inflation, industrial production, GDP, energy, renewable energy, higher education, school education, gender, health, disability, housing, NSS education consumption, environment, trade, agriculture, consumption, economic census, and digital literacy
...
| **NSS81** | NSS 81st Round — Comprehensive Annual Modular Survey | Annual modular indicators, employment, education, health access |
...
├── tests/                   # Pytest suite (covering all 26 datasets)
...
Runs in-process against the MCP server (no running server needed). Covers all 26 datasets across all 4 tools. See [CONTRIBUTING.md](CONTRIBUTING.md#testing) for details.
